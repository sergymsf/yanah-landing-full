...
import * as _uploadthing_shared67 from "@uploadthing/shared";
...
declare const createUploadthing: <TErrorShape extends Json>(opts?: CreateBuilderOptions<TErrorShape>) => <TRouteOptions extends _uploadthing_shared67.RouteOptions>(input: _uploadthing_shared67.FileRouterInputConfig, config?: TRouteOptions | undefined) => UploadBuilder<{
