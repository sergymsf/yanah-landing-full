import * as Micro$4 from "effect/Micro";
import * as Micro$3 from "effect/Micro";
import * as Micro$2 from "effect/Micro";
import * as Micro$1 from "effect/Micro";
...
declare const InvalidRouteConfigError_base: new <A extends Record<string, any> = {}>(args: effect_Types0.Equals<A, {}> extends true ? void : { readonly [P in keyof A as P extends "_tag" ? never : P]: A[P] }) => Micro$4.YieldableError & {
...
declare const UnknownFileTypeError_base: new <A extends Record<string, any> = {}>(args: effect_Types0.Equals<A, {}> extends true ? void : { readonly [P in keyof A as P extends "_tag" ? never : P]: A[P] }) => Micro$4.YieldableError & {
...
declare const InvalidFileTypeError_base: new <A extends Record<string, any> = {}>(args: effect_Types0.Equals<A, {}> extends true ? void : { readonly [P in keyof A as P extends "_tag" ? never : P]: A[P] }) => Micro$4.YieldableError & {
...
declare const InvalidFileSizeError_base: new <A extends Record<string, any> = {}>(args: effect_Types0.Equals<A, {}> extends true ? void : { readonly [P in keyof A as P extends "_tag" ? never : P]: A[P] }) => Micro$4.YieldableError & {
...
declare const InvalidURLError_base: new <A extends Record<string, any> = {}>(args: effect_Types0.Equals<A, {}> extends true ? void : { readonly [P in keyof A as P extends "_tag" ? never : P]: A[P] }) => Micro$4.YieldableError & {
...
declare const RetryError_base: new <A extends Record<string, any> = {}>(args: effect_Types0.Equals<A, {}> extends true ? void : { readonly [P in keyof A as P extends "_tag" ? never : P]: A[P] }) => Micro$4.YieldableError & {
  readonly _tag: "RetryError";
} & Readonly<A>;
declare class RetryError extends /** #__PURE__ */

RetryError_base {}
declare const FetchError_base: new <A extends Record<string, any> = {}>(args: effect_Types0.Equals<A, {}> extends true ? void : { readonly [P in keyof A as P extends "_tag" ? never : P]: A[P] }) => Micro$4.YieldableError & {
...
declare const InvalidJsonError_base: new <A extends Record<string, any> = {}>(args: effect_Types0.Equals<A, {}> extends true ? void : { readonly [P in keyof A as P extends "_tag" ? never : P]: A[P] }) => Micro$4.YieldableError & {
...
declare const BadRequestError_base: new <A extends Record<string, any> = {}>(args: effect_Types0.Equals<A, {}> extends true ? void : { readonly [P in keyof A as P extends "_tag" ? never : P]: A[P] }) => Micro$4.YieldableError & {
...
declare const UploadPausedError_base: new <A extends Record<string, any> = {}>(args: effect_Types0.Equals<A, {}> extends true ? void : { readonly [P in keyof A as P extends "_tag" ? never : P]: A[P] }) => Micro$4.YieldableError & {
  readonly _tag: "UploadAborted";
} & Readonly<A>;
declare class UploadPausedError extends /** #__PURE__ */

UploadPausedError_base {}
declare const UploadAbortedError_base: new <A extends Record<string, any> = {}>(args: effect_Types0.Equals<A, {}> extends true ? void : { readonly [P in keyof A as P extends "_tag" ? never : P]: A[P] }) => Micro$4.YieldableError & {
  readonly _tag: "UploadAborted";
} & Readonly<A>;
 ...
 * ```
 */
declare const fillInputRouteConfig: (routeConfig: FileRouterInputConfig) => Micro$3.Micro<ExpandedRouteConfig, InvalidRouteConfigError>;
/**
 ...
 */
declare const matchFileType: (file: FileProperties, allowedTypes: FileRouterInputKey[]) => Micro$3.Micro<FileRouterInputKey, UnknownFileTypeError | InvalidFileTypeError>;
declare const FILESIZE_UNITS: readonly ["B", "KB", "MB", "GB", "TB"];
type FileSizeUnit = (typeof FILESIZE_UNITS)[number];
declare const fileSizeToBytes: (fileSize: FileSize) => Micro$3.Micro<number, InvalidFileSizeError>;
...
declare const getRequestUrl: (req: Request) => Micro$3.Micro<URL, InvalidURLError, never>;
declare const getFullApiUrl: (maybeUrl?: string) => Micro$3.Micro<URL, InvalidURLError>;
...
declare const fetchEff: (input: string | URL, init?: RequestInit) => Micro$1.Micro<ResponseWithURL, FetchError, FetchContext>;
declare const parseResponseJson: (res: ResponseWithURL) => Micro$1.Micro<unknown, InvalidJsonError | BadRequestError>;
